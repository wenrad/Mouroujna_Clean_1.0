...
import com.droidmentor.mouroujnaClean.LocationUtil.LocationHelper;
...
public class MyLocationUsingHelper extends AppCompatActivity implements ConnectionCallbacks,
        ...
        rlPick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLastLocation != null) {
                    ...
                    showToast("Merci d'activer la géolocalisation");
                }
            }
        });
    ...
    public void getAddress()
    {
        ...
        if(locationAddress!=null)
        {
            ...
            String alt = Double.toString(locationAddress.getLatitude());
            String lg = Double.toString(locationAddress.getLongitude());
