...
import com.droidmentor.mouroujnaClean.LocationUtil.PermissionUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnmap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Address locationAddress=getAddress(lat1,long2);
                Double alt = locationAddress.getLatitude();
                Double lg = locationAddress.getLongitude();

                Intent maIntention=new Intent(MyLocationUsingLocationAPI.this,MapsActivity.class);
                maIntention.putExtra("lat", alt);
                maIntention.putExtra("lang", lg);

                startActivity(maIntention);
        ...
        btnProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String alt2 = Double.toString(locationAddress.getLatitude());
                String lg2 = Double.toString(locationAddress.getLongitude());
                Intent maIntention=new Intent(MyLocationUsingLocationAPI.this,Formulaire.class);
                maIntention.putExtra("lat", alt2);
                maIntention.putExtra("lang", lg2);
